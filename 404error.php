...
<head>
    ...
    <title>Global Clothiers|404 Error — Page Not Found</title>
                ...
                <td>
                    <table>
                        ...
                        <div style="margin-left:50px;font-family:Arial;font-size:30px;color:#F05A28;">
                            <p>
                                I say, that's a 404 Error!
                                <br> Whoops! We don't seem to have that page.</p>
                        </div>

                        <p class="search_title" style="margin-left:50px;"><a href="index.php">Click Here to Continue Shopping</a>
                        </p>

                        <p style="margin-left:50px;font-family:Arial;font-size:15px;color:#F05A28;">
                            This is the <strong>FAKE 404 ERROR PAGE</strong> that we've created for Adobe Training Services students to code. This is not the real 404 error page that is served up when a Web page is not found. When you code your own site, please remember to apply the "Error Page" code only to the page that is served when a URL or link is bad.
                        </p>
