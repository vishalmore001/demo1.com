...
<script>
    ...
    digitalData = {
        page: {
            pageName: "Men's Page",
            siteSection: "Men's Section",
            server: "USA Server"
        },
    };
</script>

    <title>Global Clothiers|Men</title>
                    ...
                    <div class="categorypage">
                        <td valign="top">
                            <div style="width:195px;margin-right:5px;">
                                <a href="activewear/activewear.php">
                                    <img src="http://ats-sb.adobe.com/jjsite/include/images/active_men.jpg" class="photo" width="190" border="0" />
                                </a>
                                <br />
                                <div class="category">
                                    <a href="activewear/activewear.php">Shop<br />Activewear</a>
                                </div>
                            </div>
                        </td>
                        <td valign="top">
                            <div style="width:195px;margin-right:5px;">
                                <a href="fineapparel/fineapparel.php">
                                    <img src="http://ats-sb.adobe.com/jjsite/include/images/fa_man.jpg" class="photo" width="190" border="0" />
                                </a>
                                <br />
                                <div class="category"><a href="fineapparel/fineapparel.php">Shop<br />Fine Apparel</a>
                                </div>
                            </div>
                        </td>
                        <td valign="top">
                            <div style="width:195px;margin-right:5px;">
                                <a href="#"><img src="http://ats-sb.adobe.com/jjsite/include/images/leather_shoes.jpg" class="photo" width="190" border="0" />
                                </a>
                                <br />
                                <div class="category"><a href="#">Shop<br />Footwear</a>
                                </div>
                            </div>
                        </td>
                        <td valign="top">
                            <div style="width:195px;margin-right:5px;">
                                <a href="#"><img src="http://ats-sb.adobe.com/jjsite/include/images/redtie.jpg" class="photo" width="190" border="0" />
                                </a>
                                <br />
                                <div class="category">
                                    <a href="#">Shop<br />Accessories</a>
                                </div>
                            </div>
                        </td>
                    </div>
