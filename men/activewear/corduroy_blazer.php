...
<head>
    ...
    <title>Global Clothiers|Men|Activewear|Corduroy Blazer</title>
        ...
        <div id="wrapper">
            ...
            <table border="0">
                <tr>
                    <td valign="top">
                        <div class="product">
                            <img src="http://ats-sb.adobe.com/jjsite/include/images/man-active3.jpg" class="photo" width="300" border="0" />
                            <br />
                            <div class="search_title">Corduroy Blazer</div>
                    ...
                    <td valign="top">
                        <div class="description">
                            ...
                            <div class="search_title" name="product">Corduroy Blazer</div>
                            This is the nicest casual jacket available.
                            <p>
                                <span class="cart">
<form action="../../checkout/shoppingcart.php">
<button type=submit onclick="simpleCart.add('name=Corduroy Blazer','price=709.99','image=http://ats-sb.adobe.com/jjsite/include/fa_man.jpg');" name="addToCart" value="200240" class="button">ADD TO CART</button>
</form>
</span>
                                <p />
                        </div>
