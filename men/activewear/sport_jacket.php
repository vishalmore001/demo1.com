    ...
    <script>
        ...
        digitalData = {
            ...
            product: {
                ...
                productID: "200244",
                productName: "Sport Jacket"
            },
        };
    </script>

    <title>Global Clothiers|Men|Activewear|Sport Jacket</title>
    ...
    <div id="superwrap">
        ...
        <div id="wrapper">
            ...
            <table border="0">
                <tr>
                    <td valign="top">
                        <div class="product">
                            <img src="http://ats-sb.adobe.com/jjsite/include/images/man-active4.jpg" class="photo" width="300" border="0" />
                            <br />
                            <div class="search_title">Sport Jacket</div>
                            By Wasatch Sport
                            <br /> Price: $240.00
                            <br /> sku: 200244
                            <br />
        ...
        <td valign="top">
            <div class="description">
                <div class="search_title" name="product">Sport Jacket</div>
                It's warm, stylish and red.
                <p>
                    <span class="cart">
<form action="../../checkout/shoppingcart.php">
<button type=submit onclick="simpleCart.add('name=Sport Jacket','price=240.00','image=http://ats-sb.adobe.com/jjsite/include/man-active4.jpg');" name="addToCart" value="200244" class="button">ADD TO CART</button>
</form>
</span>
                    <p />
