...
<head>
    ...
    <title>Global Clothiers|Men|Activewear|Military Jacket</title>
    ...
    <div id="superwrap">
        <div id="wrapper">
            ...
            <table border="0">
                <tr>
                    <td valign="top">
                        <div class="product">
                            <img src="http://ats-sb.adobe.com/jjsite/include/images/active_men.jpg" class="photo" width="300" border="0" />
                            <br />
                            <div class="search_title">Military Jacket</div>
                            By Uintah Modern
                            <br /> Price: $750.00
                            <br /> sku: 200241
                            <br />
        ...
        <td valign="top">
            <div class="description">
                <div class="search_title" name="product">Military Jacket</div>
                This modern jacket keeps you cool in the summer and warm in the winter.
                <p>
                    <span class="cart">
<form action="../../checkout/shoppingcart.php">
<button type=submit onclick="simpleCart.add('name=Military Jacket','price=750.00','image=http://ats-sb.adobe.com/jjsite/include/active_men.jpg');" name="addToCart" value="200241" class="button">ADD TO CART</button>
</form>
