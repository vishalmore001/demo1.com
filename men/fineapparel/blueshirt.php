...
<head>
    ...
    <title>Global Clothiers|Men|Fine Apparel|Blue Shirt</title>
    ...
    <div id="superwrap">
        ...
        <div id="wrapper">
            ...
            <table border="0">
                <tr>
                    <td valign="top">
                        <div class="product">
                            <img src="http://ats-sb.adobe.com/jjsite/include/images/man-apparel4.jpg" class="photo" width="300" border="0" />
                            <br />
                            <div class="search_title">Blue Shirt</div>
                            By Suomi Shirt
                            <br /> Price: $289.99
                            <br /> sku: 201241
                            <br />
        ...
        <td valign="top">
            <div class="description">
                <div class="search_title" name="product">Blue Shirt</div>
                It's a blue shirt. It's probably cotton or rayon or something.
                <p>
                    <span class="cart">
<form action="../../checkout/shoppingcart.php">
<button type=submit onclick="simpleCart.add('name=Blue Shirt','price=289.99','image=http://ats-sb.adobe.com/jjsite/include/man-apparel4.jpg');" name="addToCart" value="201241" class="button">ADD TO CART</button>
</form>
</span>
                    <p />
            </div>
