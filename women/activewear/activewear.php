...
<head>
    ...
    <script>
        ...
        digitalData = {
            page: {
                pageName: "Activewear Page",
                siteSection: "Women's Section",
                siteSubsection: "Activewear",
                server: "USA Server"
            },
        };
    </script>

    <title>Global Clothiers|Women|Activewear</title>
...
<body>
    ...
    <div id="superwrap">
        <div id="wrapper">
            ...
            <!---------------------->
            <br />
            <span class="category">Women's Activewear</span>
            <table border="0">
                <tr>
                    <div class="categorypage">
                        <td valign="top">
                            ...
                            <div style="width:195px;margin-right:5px;">
                                <a href="waist_puffer_jacket.php"><img src="http://ats-sb.adobe.com/jjsite/include/images/active1.jpg" class="photo" width="190" border="0" />
                                </a>
                                <br />

                                <div class="search_title"><a href="waist_puffer_jacket.php">Tie-Waist Puffer Jacket</a>
                                </div>
                                By Escape Inversion
                                <br /> Price: $1849.99
                                <br /> sku: 100240
                        ...
                        <div style="width:195px;margin-right:5px;">
                            <div class="search_content">
                                <div class="search_content_inner">
                                    ...
                                    <a href="fur_trim_ski_jacket.php"><img src="http://ats-sb.adobe.com/jjsite/include/images/active2.jpg" class="photo" width="190" border="0" />
                                    </a>
                                    <br />

                                    <div class="search_title"><a href="fur_trim_ski_jacket.php">Fur Trim Ski Jacket</a>
                                    </div>
                        ...
                        <div style="width:195px;margin-right:5px;">
                            ...
                            <div class="search_content">
                                <div class="search_content_inner">
                                    ...
                                    <a href="frontzip_ski_jacket.php"><img src="http://ats-sb.adobe.com/jjsite/include/images/active3.jpg" class="photo" width="190" border="0" />
                                    </a>
                                    <br />


                                    <div class="search_title"><a href="frontzip_ski_jacket.php">Front-Zip Ski Jacket</a>
                                    </div>
                    ...
                    <td valign="top">
                        ...
                        <div style="width:195px;margin-right:5px;">
                            <div class="search_content">
                                <div class="search_content_inner">
                                    <a href="scrunched_leg_cargo_pants.php"><img src="http://ats-sb.adobe.com/jjsite/include/images/active4.jpg" class="photo" width="190" border="0" />
                                    </a>
                                    <br />

                                    <div class="search_title"> <a href="scrunched_leg_cargo_pants.php">Scrunched Leg Cargo Pants</a>
                                    </div>
                                    By Moab Limited
                                    <br /> Price: $650.00
                                    <br /> sku: 100233
