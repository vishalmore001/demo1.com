...
<head>
    ...
    <script>
        ...
        digitalData = {
            page: {
                pageName: "Front-Zip Ski Jacket Page",
    ...
    <title>Global Clothiers|Women|Activewear|Front-Zip Ski Jacket</title>
    ...
    <div id="superwrap">
        ...
        <div id="wrapper">
            ...
            <table border="0">
                <tr>
                    <td valign="top">
                        <div class="product">
                            <img src="http://ats-sb.adobe.com/jjsite/include/images/active3.jpg" class="photo" width="300" border="0" />
                            <br />
                            <div class="search_title">

                                Zip-Front Ski Jacket</div>
                            By Sapporo Sport
                            <br /> Price: $1714.99
                            <br /> sku: 100244
                            <br />
        ...
        <td valign="top">
            <div class="description">
                <div class="search_title" name="product">Zip-Front Ski Jacket</div>
                It's stylishly puffy.
                <p><span class="cart">
<form action="../../checkout/shoppingcart.php">
<button type=submit onclick="simpleCart.add('name=Front-Zip Ski Jacket','price=1714.99','image=http://ats-sb.adobe.com/jjsite/include/images/active3.jpg');" name="addToCart" value="100244" class="button">ADD TO CART</button>
</form>
</span>
                    <p />
            </div>
    ...
    <!--start footer--><span class="footer">
    </span>
    </div>
    <!--End footer-->
