...
<head>
    ...
    <script>
        ...
        digitalData = {
            page: {
                pageName: "Tie-Waist Puffer Jacket Page",
            ...
            product: {
               ...
               productID: "100240",
               productName: "Tie-Waist Puffer Jacket"
            },
        };
    </script>

    <title>Global Clothiers|Women|Activewear|Tie-Waist Puffer Jacket</title>
    ...
    <div id="superwrap">
            ...
            <table border="0">
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <div class="product">
                            <img src="http://ats-sb.adobe.com/jjsite/include/images/active1.jpg" class="photo" width="300" border="0" />
                            <br />

                            <div class="search_title">Tie-Waist Puffer Jacket</div>
        ...
        <td valign="top">
            <div class="description">
                <div class="search_title" name="product">Tie-Waist Puffer Jacket</div>

                Ski in comfort down Snowbird, Deer Valley, Solitude, Park City and Brighton!

                <p>
                    <span class="cart">
<form action="../../checkout/shoppingcart.php">
<button type=submit onclick="simpleCart.add('name=Tie-Waist Puffer Jacket','price=1849.99','image=http://ats-sb.adobe.com/jjsite/include/active1.jpg');"  name="addToCart" value="100240" class="button">ADD TO CART</button>
</form>
</span>
