...
<head>
    ...
    <script>
        ...
        digitalData = {
            page: {
                pageName: "Women:Activewear:Fur Trim Ski Jacket Page",
                siteSection: "Women Section",
            ...
            product: {
               ...
               productID: "100241",
               productName: "Fur Trim Ski Jacket"
            },
        };
    </script>

    <title>Global Clothiers|Women|Activewear|Fur Trim Ski Jacket</title>
            ...
            <table border="0">
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <div class="product">
                            <img src="http://ats-sb.adobe.com/jjsite/include/images/active2.jpg" class="photo" width="300" border="0" />
                            <br />

                            <div class="search_title">Fur Trim Ski Jacket</div>
                    ...
                    <td valign="top">
                        <div class="description">
                            ...
                            <br />
                            <div class="search_title" name="product">Fir Trim Ski Jacket</div>
                            Arrive at Sundance in style because it's going to be cold. What is this, Miami Beach? Not hardly.

                            <p>
                                <span class="cart">
<form action="../../checkout/shoppingcart.php">
<button type=submit onclick="simpleCart.add('name=Fur-Trim Ski Jacket','price=2259.99');" name="addToCart" value="100241" class="button">ADD TO CART</button>
</form>  
</span>
