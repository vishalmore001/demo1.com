...
<head>
    ...
    <title>Global Clothiers|Women|Fine Apparel|Silk Dress</title>
    ...
    <div id="superwrap">
        ...
        <div id="wrapper">
            ...
            <table border="0">
                <tr>
                    <td valign="top">
                        <div class="product">
                            <img src="http://ats-sb.adobe.com/jjsite/include/images/silk_dress.jpg" class="photo" width="300" border="0" />
                            <br />
                            <div class="search_title">Silk Dress</div>
        ...
        <td valign="top">
            ...
            <div class="description">
                <div class="search_title" name="product">Silk Dress</div>
                Made from happy silk worms. Happy silk worms make better silk.
                <p><span class="cart">
<form action="../../checkout/shoppingcart.php">
<button type=submit onclick="simpleCart.add('name=Silk Dress','price=2449.99','image=http://ats-sb.adobe.com/jjsite/include/silk_dress.jpg');" name="addToCart" value="101344" class="button">ADD TO CART</button>
</form>
</span>
                    <p />
            </div>
