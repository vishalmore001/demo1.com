...
<head>
    ...
    <script>
        ...
        digitalData = {
            page: {
                pageName: "Newsletter Subscription Completion Page",
                siteSection: "Company Section",
                siteSubsection: "Newsletters",
                server: "USA Server",
				newsletter: "GC Living|GC Foreign Policy|GC Special Offers|Random Spam"
            },
        };
    </script>


    <title>Global Clothiers|Company|Newsletter Subscription Completion</title>
...
<body>
    ...
    <div id="superwrap">
        ...
        <div id="wrapper">
            ...
            <br>
            <table border="0" height="250" width="700" style="margin-left:50px;margin-top:30px;">
                <td>
                    <table>
                        <tr>
                            <td>
                                <img src="http://ats-sb.adobe.com/jjsite/include/images/email2.jpg" />
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td>
                    <table>
                        ...
                        <span style="font-family:Helvetica,Arial;font-size:30px;color:#F05A28;">
Thanks for signing up for the GC Newsletter!
</span>
                        <br/>
                        <br/>
