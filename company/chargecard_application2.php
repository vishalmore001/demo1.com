...
<head>
    ...
    <script>
        ...
        digitalData = {
            page: {
                pageName: "Charge Card Application Page 2",
                siteSection: "Company Section",
                siteSubsection: "Charge Card",
                server: "USA Server"
            },
        };
    </script>
    ...
    <title>Global Clothiers|Company|GC Charge Card Step 2</title>
...
<body>
    ...
    <div id="superwrap">
        <div id="wrapper">
                                ...
                                <li><a href="#" onmouseover="mopen('m7')" onmouseout="mclosetime()">ELECTRONICS</a>
                                    ...
                                    <li>
                                        ...
                                        <div id="m8" onmouseover="mcancelclosetime()" onmouseout="mclosetime()">
                                            <a href="../company/chargecard_application1.php">Geo Charge Card</a>
                                            <a href="../company/travel1.php">Geo Travel</a>
                                            <a href="../company/newsletter1.php">Geo Newsletter</a>
            ...
            <br>
            <table border="0" height="250" width="750" style="margin-left:50px;margin-top:30px;">
                <td>
                    <table>
                        <tr>
                            <td>
                                <img src="http://localhost:8080/globalclothiers/images/gc_chargecard_greenfield.png" width="330" height="380" class="photo" />
                            </td>
                        </tr>
                ...
                <td>
                    <table>
                        ...
                        <span class="description">GC Charge Card Application 
<br/>Step 2</span>



                        <div class="form">
                            <form action="http://training.adobe.com">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="firstname" class="textinput" value="">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="lastname" class="textinput" value="">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="email" class="textinput" value="">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="address" class="textinput" value="">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="city" class="textinput" value="">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="zip" class="textinput" value="">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="country" size="1" class="textinput">
                                            ...
                                            <option>Aringland Islands</option>
                                            ...
                                            <option>Cocircte d'Ivoire (Ivory Coast)</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="phone2" class="textinput" size="20" value="">
                                    </td>
                                </tr>
                                ...
                                <!--THIS IS THE PROCEED TO APPLY BUTTON-->

                                <tr>
                                    <td>
                                    </td>
                                    <td>
                                        <a href="" class="button2" onClick="_satellite.track('ccapp')">Proceed to Apply</a>
<!--http://ats-sb.adobe.com/jjsite/include/include/charge_card_site.php-->
                                    </td>
                                </tr>

                                <!--IN CASE YOU MISSED IT, IT'S RIGHT ABOVE THIS MESSAGE :)-->

                                <tr>
                                    <td>
                                    </td>
                                    <td>
                                        <span style="font:bold 9px Helvetica,Arial;color:#000">(completed on a third-party site)</span>
                                    </td>
                                </tr>
